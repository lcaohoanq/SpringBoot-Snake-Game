...
public class DemoDataRunner implements CommandLineRunner {
    ...
    private Gender getOrCreateGenderField(UserGenderEnum userGender){
        Gender gender = genderRepository.findByGenderName(userGender);
        if(gender == null){
            gender = new Gender(userGender.getGender(), userGender);
    ...
    private User getOrCreateUser(Long id, String firstName, String lastName, String email, String phone, String password, String birthday, String address, Gender gender, Role role, Status status, String createdAt, String updatedAt, byte[] avatarUrl, int subscription) {
    ...
    public void run(String... args) {
        ...
        Gender male = getOrCreateGenderField(UserGenderEnum.MALE);
        Gender female = getOrCreateGenderField(UserGenderEnum.FEMALE);
        Gender other = getOrCreateGenderField(UserGenderEnum.OTHER);
        Gender notProvide = getOrCreateGenderField(UserGenderEnum.NOT_PROVIDE);
        ...
        User user1 = getOrCreateUser(1L, "hoang", "luu", "hoangdz1604@gmail.com", null, hashedPassword, "1999-07-01", "Duong Vo Van Hat, Ho Chi Minh City", male, adminRole, unverified, LocalDateTime.now().toString(), LocalDateTime.now().toString(), null, 1);
        User user2 = getOrCreateUser(2L, "duong", "nguyen", null, "0987654322", hashedPassword, "1999-07-01", "Thanh Pho Tam Ki, Tinh Quang Nam", male, userRole, verified, LocalDateTime.now().toString(), LocalDateTime.now().toString(), null, 0);
        User user3 = getOrCreateUser(3L, "thu", "minh", null, "0987654323", hashedPassword, "1999-07-01", "Quan 9, Thu Duc", female, userRole, banned, LocalDateTime.now().toString(), LocalDateTime.now().toString(), null, 0);
        User user4 = getOrCreateUser(4L, "nhu", "minh", "mnhw.0612@gmail.com", null, hashedPassword, "2006-12-06", "Nguyen Tat Thanh St, Da Nang City", female, userRole, banned, LocalDateTime.now().toString(), LocalDateTime.now().toString(), null, 0);
        User user5 = getOrCreateUser(5L, "chau", "bao", "doanthibaochau0410@gmail.com", null, hashedPassword, "2004-07-01", "Hoa Khanh", female, employeeRole, banned, LocalDateTime.now().toString(), LocalDateTime.now().toString(), null, 0);
        User user6 = getOrCreateUser(6L, "Duong", "Manh", "manhduonglhp4@gmail.com", null, hashedPassword, "2004-07-01", "Hoa Khanh", male, userGoldRole, unverified, LocalDateTime.now().toString(), LocalDateTime.now().toString(), null, 0);
        User user7 = getOrCreateUser(7L, "Tram", "Minh", "tramsowavy@gmail.com", null, hashedPassword, "2004-07-01", "Hoa Xuan, Hoa Vang, Da Nang", female, userPremiumRole, verified, LocalDateTime.now().toString(), LocalDateTime.now().toString(), null, 0);
        User user8 = getOrCreateUser(8L, "きむら", "山口", "test1@yahoo.com", null, hashedPassword, "2004-07-01", "Tokyo, Japan", female, userPremiumRole, verified, LocalDateTime.now().toString(), LocalDateTime.now().toString(), null, 0);
        User user9 = getOrCreateUser(9L, "えいみ", "ふかだ", "test2@gmail.com", null, hashedPassword, "2004-07-01", "Nakayama, Japan", male, userPremiumRole, verified, LocalDateTime.now().toString(), LocalDateTime.now().toString(), null, 0);
        User user10 = getOrCreateUser(10L, "Hai", "Luu Van", "test3@outlook.com", null, hashedPassword, "2004-07-01", "Tuy Loan, Hoa Phong", male, userPremiumRole, verified, LocalDateTime.now().toString(), LocalDateTime.now().toString(), null, 0);
